...
export const Ranking: React.FC = () => {
  ...
  return (
    <article className="w-6/12 md:min-w-[480px] grow">
      ...
      <ul className="w-full flex flex-col items-center  border border-[#1a1d26] mx-h-[250px] overflow-scroll rounded-6">
        ...
        <li className="w-full">
          <ul className="w-full flex flex-col items-center  [&>li:nth-child(even)]:bg-dark-blue  mx-w-[200px] max-h-[250px] ">
